...
public class GUISawtoothWave extends AbstractWidget {
	
	private SawtoothWave gen;

	int scale;
		
	public GUISawtoothWave(MyApp parent) {
		super("Sawtooth Wave", parent);
		
		this.gen = new SawtoothWave(300);
	...
	public SawtoothWave getSawtoothWave() {
		return gen;
	}
